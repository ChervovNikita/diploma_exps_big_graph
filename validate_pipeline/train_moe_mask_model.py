...
import random
import os
from common import MaskedGraphDataset, MoEConvModel, SingleDeviceWrapper
...
model = SingleDeviceWrapper(MoEConvModel(num_features=num_features, num_classes=len(labels), top_k=TOP_K).to(device), device)
