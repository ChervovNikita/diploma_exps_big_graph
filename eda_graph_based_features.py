...
EXP_NAME = 'exp_mask_graph_based_simple_graph_based'
...
class Node2VecGraphBasedDataset(Dataset):
    ...
    def get(self, idx):
        ...
        graph_features = compute_graph_based_features(sorted_nodes, subgraph_edges, node_class_masked, self.total_classes)
