...
train_dataset = MaskedGraphDatasetWithPCA(data, unknown_nodes_subset, train_nodes, val_nodes, None,
                                    split='train', mask_count=MASK_COUNT, num_samples=NUM_SAMPLES, node_classes=node_class, pca_features=pca_features)
val_dataset = MaskedGraphDatasetWithPCA(data, unknown_nodes_subset, train_nodes, val_nodes, None,
                                  split='val', mask_count=MASK_COUNT, num_samples=NUM_SAMPLES, node_classes=node_class, pca_features=pca_features)
