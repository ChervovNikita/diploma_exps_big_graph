"""
Experiment: Masking multiple nodes per graph sample with FOCAL LOSS
- Focal Loss focuses on hard examples by down-weighting easy ones
- gamma controls focusing strength (higher = more focus on hard examples)
"""
import pandas as pd
import numpy as np
...
class FocalLoss(nn.Module):
    ...
    Args:
        ...
        alpha (tensor): class weights (default: None)
